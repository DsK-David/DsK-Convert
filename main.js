  ...
  function split_by_coins(number) {
    ...
    return `<table class="app-table">
              <tr class="app-table__row">
                <td class="app-table__cell">Moedas</td>
                <td class="app-table__cell">Count</td>
              </tr>
              <tr class="app-table__row">
        <td class="app-table__cell">Quarto(25 &#162)</td>
              <td class="app-table__cell">${quarter}</td>
              </tr>
              <tr class="app-table__row">
                <td class="app-table__cell">Moeda de dez centavo (10 &#162)</td>
                <td class="app-table__cell">${dime}</td>
              </tr>
              <tr class="app-table__row">
                <td class="app-table__cell">Moeda de cinco centavo (5 &#162)</td>
                <td class="app-table__cell">${nickel}</td>
              </tr>
              <tr class="app-table__row">
                <td class="app-table__cell">Moeda de um centavo (1 &#162)</td>
